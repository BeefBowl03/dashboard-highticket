...
const NameComAPI = require('./namecom-api-backend');
const CompetitorFinder = require('./competitor-finder-backend');
const DOMAIN_DATABASES = require('./domain-databases-backend');
